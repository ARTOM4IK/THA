...
GameClient::GameClient(Role role, std::string host, uint16_t port) : role_(role), host_(std::move(host)), port_(port)
{
...
int GameClient::runInteractive( void )
{
...
std::string GameClient::prompt( void ) const
{
...
void GameClient::printIncoming(const std::string &text) const
{
...
void GameClient::receiveLoop( void )
{
...
void GameClient::handleIncoming( const Message &msg )
{
...
void GameClient::recordEvent(const std::string &time, const std::string &body)
{
...
void GameClient::showEvents( int count )
{
...
void GameClient::clearEvents( void )
{
...
void GameClient::showLocalHelp( void )
{
...
void GameClient::executeLocalLine( const std::string &line )
{
...
void GameClient::executeHackerLine( const std::vector<std::string> &args )
{
...
void GameClient::sendPacket( const std::string &mode, const std::string &endpoint, const std::string &payload )
{
...
void GameClient::sendCommand( const std::string &line )
{
...
void GameClient::listTmp( void ) const
{
...
void GameClient::catTmp( const std::string &file ) const
{
...
void GameClient::metaTmp( const std::string &file ) const
{
...
void GameClient::showInbox( void ) const
{
...
void GameClient::runBatch( const std::string &file )
{
